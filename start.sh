...
PORT=6006
UUID=dc3607ac-1dae-4e8b-805b-cfcc9447dd5f
WebPage=https://bing.com
CaddyConfig=https://raw.githubusercontent.com/mlsssnodeok/wenorth/main/etc/Caddyfile
XRayConfig=https://raw.githubusercontent.com/mlsssnodeok/wenorth/main/etc/xray.json
